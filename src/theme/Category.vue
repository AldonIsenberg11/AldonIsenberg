...
export default {
  ...
  data () {
    return {
      ...
      postsEducation: [
        { id: 4, title: 'State of The Education Gap Between Native and Web', content: 'Clearly PhoneGap, and Cordova are still required today in the Education world, but when is it really needed? Did the web ever catch up?', link: 'https://remysharp.com/2016/05/28/state-of-the-gap' },
